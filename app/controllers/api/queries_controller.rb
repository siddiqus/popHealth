...
#      results = qr.patient_results
      query = {'value.measure_id' => qr.measurel_id, 'value.sub_id' => qr.sub_id, 'value.effective_date' => qr.effective_date, 'value.provider_performances.provider_id' => qr.filters[:providers].first}
